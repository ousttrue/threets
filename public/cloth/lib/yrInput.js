...
// -------------------------------------------------------------------------------------------
// 入力
function yrInput(target)
{
	this._mouse_pos_x = 0;
	this._mouse_pos_y = 0;
	this._mouse_npos_x = 0.0;
	this._mouse_npos_y = 0.0;
	this._mouse_move_x = 0;
	this._mouse_move_y = 0;
	this._mouse_nmove_x = 0.0;
	this._mouse_nmove_y = 0.0;
	this._mouse_button_l = false;
	this._mouse_button_m = false;
	this._mouse_button_r = false;
	this._mouse_button_status_l = 0;
	this._mouse_button_status_m = 0;
	this._mouse_button_status_r = 0;
	this._key_button_w = false;		// 動的な連想配列か何かにしたい
	this._key_button_s = false;		// 
	this._key_button_a = false;		// 
	this._key_button_d = false;		// 
	this._key_button_status_w = 0;	// 
	this._key_button_status_s = 0;	// 
	this._key_button_status_a = 0;	// 
	this._key_button_status_d = 0;	// 
...
// 更新
yrInput.prototype.update = function()
{
...
// ボタンの状態を取得する
yrInput.prototype.checkButtonStatus = function(old, now)
{
	var out = 0;
...
// デバッグ表示
yrInput.prototype.debug = function(debug)
{
